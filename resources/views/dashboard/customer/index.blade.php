        ...
        <div class="row">
            <div class="col-md-3">
                <div class="card px-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h3 class="card-title py-1 fw-bold mb-0">{{ $OrderService->count() }}</h3>
              ...
              <div class="card px-3">
                  <div class="d-flex align-items-center">
                      ...
                      <div>
                          ...
                          <p class="card-text">Pesanan Diproses</p>
                      </div>
                  </div>
              </div>
          </div>
          ...
          <div class="col-md-3">
            <div class="card px-3">
                <div class="d-flex align-items-center">
                    <div class="me-2 p-3">
                        <i class="bi bi-chat-left" style="font-size: 3rem; color:#f80000ed;"></i>
                    </div>
                    <div>
                        <h3 class="card-title py-1 fw-bold mb-0">{{ $totalCancelReject }}</h3>
                        <p class="card-text">Pesanan Dibatalkan</p>
                    </div>
                </div>
            </div>
        </div>
